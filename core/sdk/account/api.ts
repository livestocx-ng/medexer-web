...
export const CommunityApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        communityControllerFetchCommunityRecords: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/account/community/records`;
         ...
         * @throws {RequiredError}
         */
        communityControllerFetchExistingUsers: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/account/community/existing-users`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        communityControllerFollowCommunityUser: async (userId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            assertParamExists('communityControllerFollowCommunityUser', 'userId', userId)
            const localVarPath = `/v1/account/community/follow-user`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const CommunityApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async communityControllerFetchCommunityRecords(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommunityInfo>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.communityControllerFetchCommunityRecords(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunityApi.communityControllerFetchCommunityRecords']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async communityControllerFetchExistingUsers(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PhoneContactInfo>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.communityControllerFetchExistingUsers(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunityApi.communityControllerFetchExistingUsers']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async communityControllerFollowCommunityUser(userId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommunityUserInfo>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.communityControllerFollowCommunityUser(userId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CommunityApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        communityControllerFetchCommunityRecords(options?: RawAxiosRequestConfig): AxiosPromise<CommunityInfo> {
            return localVarFp.communityControllerFetchCommunityRecords(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        communityControllerFetchExistingUsers(options?: RawAxiosRequestConfig): AxiosPromise<Array<PhoneContactInfo>> {
            return localVarFp.communityControllerFetchExistingUsers(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} userId Followed user id.
